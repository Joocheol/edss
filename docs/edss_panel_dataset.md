...
대학알리미 재적학생수 교차검증에서는 2023·2024년 학교구분·지역·본분교·재적학생수가 각 연도에 하나의 EDSS OpenID와 정확히 일치하고 두 해의 OpenID도 같은 학교 245개를 찾았다. 역방향 중복은 0개이며 취업 학교·연도 482개에 이름으로 연결됐다. 기존 학과서명 후보와 겹치는 24개는 모두 동의했다. 다만 공식 교차표가 아니므로 후보 파일로만 제공하고 canonical `개방ID` 대입은 0건을 유지한다.
...
- 대학알리미 2개 연도 정확일치 후보 245개·취업 학교연도 연결 482개·학과서명 동의 24개·충돌 0개; canonical 대입 0건
