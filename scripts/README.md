...
- `build_edss_duckdb.py`: 233개 이질적 패널을 소스별 독립 테이블로 하나의 제한 DuckDB에 재개 가능하게 적재한다. 업무열 수와 공통 출처열 12개를 분리 검증하고, 2010–2022 종단 취업 뷰와 OpenID가 없는 2023–2024 독립 취업 뷰를 분리해 만든다.
